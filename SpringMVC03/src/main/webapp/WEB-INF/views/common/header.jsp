			...
			<c:if test="${!empty mvo}">
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="${contextPath}/memUpdateForm.do"> <span
							class="glyphicon glyphicon-wrench">회원정보수정</a></li>
					<li><a href="${contextPath}/memImageForm.do"> <span
							class="glyphicon glyphicon-picture">사진등록</a></li>
					...
					<c:if test="${!empty mvo}">
						<c:if test="${mvo.memProfile eq '' }">	
							<!--  로그인했는데 프로필이 null인 경우 -->
							<li><img class="img-circle" src="${contextPath}/resources/images/person.png"
